...
@Component({
  ...
  standalone: true,
  imports: [Card, NgForOf, FieldsetModule],
  providers: [],
})
export class RekordeComponent {
  ...
  jahreswertungen: Rekord[] = [
    ...
    this.createRekord('Geworfene TONs', '2021/2022', 'mad', 149),
    this.createRekord('Punkte Jahreswertung', '2020/21', 'mad', 120),
    this.createRekord('Spiele gewonnen', '2020/21, 2023/24', 'mad', 40),
    this.createRekord('Spiele in Serie gewonnen', '2023/24', 'mad', 33),
    this.createRekord('Short Games geworfen', '2023/24', 'mad', 17),
    this.createRekord('Short Game, Anzahl Darts', '01.01.2007', 'Nico', 14),
  ];

  spieltagswertungen: Rekord[] = [
    this.createRekord('Geworfene 180er', '2006–2024', 'Y, Nico, mad', 2),
    this.createRekord('Geworfene 180er, Gesamt', '02.02.2013', 'Team', 3),
    this.createRekord('Geworfene 140er', '13.04.2017', 'Nico', 8),
    this.createRekord('Geworfene 140er, Gesamt', '2009–2017', 'Team', 12),
    this.createRekord('Geworfene TONs', '21.12.2019', 'mad', 22),
    this.createRekord('First 9 Dart Average', '2023/24', 'mad', 71.9),
    this.createRekord('3 Dart Average', '2019', 'mad', 62.8),
    this.createRekord('Average Darts needed', '2019', 'mad', 23.75),
  ];
